...
export async function generateMetadata() {
  return getPageMetadata('/admissions', {
    fallbackTitle: `Admissions 2026–27 — Fees, Eligibility & FAQs | ${SCHOOL_NAME}`,
    fallbackDescription: `Admissions open for 2026–27 at ${SCHOOL_NAME}, ${SCHOOL_CITY}. Eligibility by grade, required documents, transparent fee structure and frequently asked questions.`,
  })
}
...
const FALLBACK_FAQS = [
  ...
  { question: 'Do you provide transport?', answer: 'Yes — GPS-tracked buses with trained attendants cover all major areas of the city. Routes and charges are confirmed at admission.' },
